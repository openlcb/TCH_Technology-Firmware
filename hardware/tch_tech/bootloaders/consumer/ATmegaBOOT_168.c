...
#if defined __AVR_ATmega1280__ || defined __AVR_AT90CAN128__
...
#if defined(__AVR_ATmega128__) || defined (__AVR_AT90CAN128__) || defined(__AVR_ATmega1280__) || defined(__AVR_ATmega1281__)
				RAMPZ = address_high;
#endif
...
#if defined __AVR_ATmega168__  || __AVR_ATmega328P__ || __AVR_ATmega128__ || __AVR_AT90CAN128__ || __AVR_ATmega1280__ || __AVR_ATmega1281__ 
...
{
#if defined(__AVR_AT90CAN128__) //reversed for the OpenLCB board. Low = LED on
	while (count--) {
		LED_PORT &= ~_BV(LED);
		_delay_ms(100);
		LED_PORT |= _BV(LED);
