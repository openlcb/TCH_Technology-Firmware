...
// Tim Hatch 2010-1016
//
//producer Node ID !!!!! this must be change every time and node is produced !!!!
//
 //NodeID nodeid(2,1,54,1,0x10,20);    // This node's default ID 01/16/2016 13:27:00
 NodeID nodeid(2,1,0x54,1,0x10,21);