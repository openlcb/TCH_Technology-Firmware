...
// Tim Hatch 2010-1016
//
//consumer Node ID !!!!! this must be change every time and node is produced !!!!//Consumer ID
//NodeID nodeid(2,1,54,1,0x10,12); used
//NodeID nodeid(2,1,54,1,0x10,12);
NodeID nodeid(2,1,0x54,1,0x10,13);